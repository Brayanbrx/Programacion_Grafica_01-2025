...
namespace PGrafica
{
    ...
    {
        public int Handle { get; } // Id del programa shader
        public Shader(string vert = "shader.vert", string frag = "shader.frag")
        {
            CrearShadersPorDefecto(vert, frag); // si no existen los crea
...
void main() { FragColor = vec4(0.0, 0.4, 1.0, 1.0); }");
        ...
        public void Usar() => GL.UseProgram(Handle); // Activa Shader para el Pipeline Grafico
